...
| P1 (harness implemented; run pending) | B1 | Majority-of-3/stronger-model benchmark certification | Feynman, Autoprompt | Variance and residuals are published; no point estimate is called certification |
